...
public interface TimeSlotRepository extends JpaRepository<TimeSlot, UUID> {
    ...
    @Query(value = "select t from timeslots t where t.bookingDay = ?1 and t.doctorId = ?2")
    List<TimeSlot> getDoctorTimeSlotsForTheDay(LocalDate localDate, UUID doctorId);
